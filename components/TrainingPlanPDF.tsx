...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingBottom: 10,
    position: 'relative', // Wichtig für Logo-Positionierung
  },
  headerTitle: {
    fontSize: 24,
    ...
    marginBottom: 5,
    paddingRight: 50, // Platz für das Logo lassen, falls es da ist
  },
  headerMeta: {
    flexDirection: 'row',
    gap: 15,
...
// Hier Interface erweitert: clubLogo ist optional (?)
export const TrainingPlanPDF = ({ plan, clubLogo }: { plan: any, clubLogo?: string | null }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          {/* HIER IST DIE LOGIK: Wenn Logo da ist, zeig es an. Wenn nicht, passiert nichts. */}
          {clubLogo && (
             <Image src={clubLogo} style={styles.clubLogo} />
          )}
        </View>
        ...
        <Text style={styles.footer} fixed>
          Trainingseinheit erstellt mit MyCOACH.at
        </Text>
